 ...
 * using path coverage and data flow coverage based testing methods.
 *
 * @see <a href=
...
public class GetProjectileDragPathTest {
     ...
     */
    @ParameterizedTest
    @MethodSource("pathCoverageTestCases")
    @MockitoSettings(strictness = Strictness.LENIENT)
    public void testPathCoverageCases(Vector3d velocity, double rho, double A, double Cd, Vector3d expected) {
    ...
    *
    * @see <a href=
    *      "https://github.com/katanallama/projectile-simulation-suite/blob/main/docs/testing.md#structural-testing">Testing
    *      Documentation</a> describes the full test design and procedure.
    *
    * @return Stream of Arguments containing different test cases.
    */
    private static Stream<Arguments> pathCoverageTestCases() {
        return Stream.of(
